...
namespace gpk
{
	...
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, KEY				,  5);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, LITERAL			,  6);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, UNARY_NOT		,  7);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, CODEPOINT		,  8);
