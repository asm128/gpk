...
namespace gpk
{
	...
	tplt<tpnm _t, size_t _sizeDepth, size_t _sizeWidth>	stincxp	uint32_t	size		(const _t (&/*staticArray*/)[_sizeDepth][_sizeWidth])	noexcept	{ return _sizeDepth * _sizeWidth;					}
	...
	tplt<tpnm _t, size_t _sizeDepth, size_t _sizeWidth>	stincxp	uint32_t	byte_count	(const _t (&/*staticArray*/)[_sizeDepth][_sizeWidth])	noexcept	{ return ::gpk::size<_t>(_sizeDepth*_sizeWidth);	}
}
