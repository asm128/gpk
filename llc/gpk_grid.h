...
#pragma pack(pop)
	...
	typedef	::gpk::grid<const ::gpk::n2u8>		g2u8	;
	typedef	::gpk::grid<const ::gpk::n2u16>		g2u16	;
	typedef	::gpk::grid<const ::gpk::n2u32>		g2u32	;
	typedef	::gpk::grid<const ::gpk::n2u64>		g2u64	;
	...
	typedef	::gpk::grid<::gpk::n2u8>			gn2u8	;
	typedef	::gpk::grid<::gpk::n2u16>			gn2u16	;
	typedef	::gpk::grid<::gpk::n2u32>			gn2u32	;
	typedef	::gpk::grid<::gpk::n2u64>			gn2u64	;
	...
	typedef	::gpk::grid<const ::gpk::n2u8>		gc2u8	;
	typedef	::gpk::grid<const ::gpk::n2u16>		gc2u16	;
	typedef	::gpk::grid<const ::gpk::n2u32>		gc2u32	;
	typedef	::gpk::grid<const ::gpk::n2u64>		gc2u64	;
	...
	typedef	::gpk::grid<::gpk::n3u8>			gn3u8	;
	typedef	::gpk::grid<::gpk::n3u16>			gn3u16	;
	typedef	::gpk::grid<::gpk::n3u32>			gn3u32	;
	typedef	::gpk::grid<::gpk::n3u64>			gn3u64	;
	...
	typedef	::gpk::grid<const ::gpk::n3u8>		gc3u8	;
	typedef	::gpk::grid<const ::gpk::n3u16>		gc3u16	;
	typedef	::gpk::grid<const ::gpk::n3u32>		gc3u32	;
	typedef	::gpk::grid<const ::gpk::n3u64>		gc3u64	;
