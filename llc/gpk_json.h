...
#pragma pack(pop)
	...
	static inline			::gpk::error_t											jsonArrayValueGet		(const ::gpk::SJSONReader& reader, uint32_t iNode, uint32_t indexOfValueToGet)			noexcept	{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); return ::gpk::jsonArrayValueGet(*reader.Tree[iNode], indexOfValueToGet); }
							...
							::gpk::error_t											jsonObjectValueGet		(const ::gpk::SJSONNode& node, const ::gpk::view_array<::gpk::vcc>& views, const ::gpk::vcs & key);
	static inline			::gpk::error_t											jsonObjectValueGet		(const ::gpk::SJSONReader& reader, uint32_t iNode, const ::gpk::vcs& key)	noexcept	{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); return ::gpk::jsonObjectValueGet(*reader.Tree[iNode], reader.View, {key.begin(), key.size()}); }
							...
							::gpk::error_t											jsonObjectKeyList		(const ::gpk::SJSONNode& node, const ::gpk::view_array<::gpk::vcc>& views, ::gpk::aobj<::gpk::vcc> & keys);
							::gpk::error_t											jsonObjectKeyList		(const ::gpk::SJSONNode& node, const ::gpk::view_array<::gpk::vcc>& views, ::gpk::apod<int32_t> & indices, ::gpk::aobj<::gpk::vcc> & keys);
	...
	static inline			::gpk::error_t											jsonObjectKeyList		(const ::gpk::SJSONReader& reader, uint32_t iNode, const ::gpk::view_array<::gpk::vcc>& views, ::gpk::aobj<::gpk::vcc> & keys)											{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); return jsonObjectKeyList(*reader.Tree[iNode], views, keys);			}
	static inline			::gpk::error_t											jsonObjectKeyList		(const ::gpk::SJSONReader& reader, uint32_t iNode, const ::gpk::view_array<::gpk::vcc>& views, ::gpk::apod<int32_t> & indices, ::gpk::aobj<::gpk::vcc> & keys)	{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); return jsonObjectKeyList(*reader.Tree[iNode], views, indices, keys);	}
	...
	static inline			::gpk::error_t											jsonArraySize			(const ::gpk::SJSONReader& reader, uint32_t iNode)	noexcept	{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); return ::gpk::jsonArraySize(*reader.Tree[iNode]); }
							::gpk::error_t											jsonCompareNumber		(const ::gpk::SJSONNode& node, const ::gpk::view_array<::gpk::vcc>& views, const ::gpk::SJSONNode& other, const ::gpk::view_array<::gpk::vcc>& otherViews);
							::gpk::error_t											jsonCompareArray		(const ::gpk::SJSONNode& node, const ::gpk::view_array<::gpk::vcc>& views, const ::gpk::SJSONNode& other, const ::gpk::view_array<::gpk::vcc>& otherViews);
							::gpk::error_t											jsonCompareObject		(const ::gpk::SJSONNode& node, const ::gpk::view_array<::gpk::vcc>& views, const ::gpk::SJSONNode& other, const ::gpk::view_array<::gpk::vcc>& otherViews);
	static inline			::gpk::error_t											jsonCompareArray		(const ::gpk::SJSONNode& node, const ::gpk::SJSONNode& other, const ::gpk::view_array<::gpk::vcc>& views) { return ::gpk::jsonCompareArray	(node, views, other, views); }
	static inline			::gpk::error_t											jsonCompareObject		(const ::gpk::SJSONNode& node, const ::gpk::SJSONNode& other, const ::gpk::view_array<::gpk::vcc>& views) { return ::gpk::jsonCompareObject	(node, views, other, views); }
	static inline			::gpk::error_t											jsonCompareNumber		(const ::gpk::SJSONNode& node, const ::gpk::SJSONNode& other, const ::gpk::view_array<::gpk::vcc>& views) { return ::gpk::jsonCompareNumber	(node, views, other, views); }

							::gpk::error_t											jsonTreeRebuild			(::gpk::view_array<::gpk::SJSONToken>& in_object, ::gpk::aobj<::gpk::pobj<::gpk::SJSONNode>> & out_nodes);
	struct SJSONFile {
	...
	typedef ::gpk::SKeyVal<::gpk::vcc, ::gpk::SJSONFile>				TKeyValJSONFile;
							...
							::gpk::error_t											jsonWrite				(const ::gpk::SJSONNode* node, const ::gpk::view_array<::gpk::vcc> & jsonViews, ::gpk::apod<char_t> & output);
							::gpk::error_t											jsonArraySplit			(const ::gpk::SJSONNode & jsonArrayToSplit, const ::gpk::view_array<::gpk::vcc> & jsonViews, const uint32_t blockSize, ::gpk::aobj<::gpk::apod<char_t>> & outputJsons);
	...
	struct SJSONFieldBinding {
							...
							::gpk::error_t											jsonMapToFields			(::gpk::apod<int32_t> & indicesOfFields, const ::gpk::view_array<const ::gpk::SJSONFieldBinding> fields, const ::gpk::view_array<const ::gpk::TKeyValConstChar> fieldMaps);
							::gpk::error_t											jsonFieldsToMap			(::gpk::apod<int32_t> & indicesOfFields, const ::gpk::view_array<const ::gpk::SJSONFieldBinding> fields, const ::gpk::view_array<const ::gpk::TKeyValConstChar> fieldMaps);
} // namespace
