...
#pragma pack(push, 1)
	...
	GDEFINE_ENUM_VALUE(CELESTIAL_BODY, Orbit	, 0);
	GDEFINE_ENUM_VALUE(CELESTIAL_BODY, Star		, 1);
	GDEFINE_ENUM_VALUE(CELESTIAL_BODY, Planet	, 2);
	GDEFINE_ENUM_VALUE(CELESTIAL_BODY, Moon		, 3);
	...
	struct SDetailStar {
		...
		float					DistanceFromSun			= {}; // 57.9		// (10^6 km)	// 7
