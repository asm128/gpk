...
#pragma pack(pop)
	...
	static inline	uint32_t									mapTableContainerFromData	(const ::gpk::view_const_char & sequenceToFind, const uint32_t countContainers)	{
		uint64_t													container					= 0;
		::gpk::crcGenerate(sequenceToFind, container);
		return (uint32_t)container % countContainers;
	}
	...
	template<typename _tMapBlock>
		...
		uint32_t													container					= ::gpk::mapTableContainerFromData(sequenceToFind, mapTable.BlockConfig.Containers);
	...
	template<typename _tMapBlock>
		...
		uint32_t													container					= ::gpk::mapTableContainerFromData(sequenceToAdd, mapTable.BlockConfig.Containers);
