...
namespace gpk
{
	...
	stainli	::gpk::error_t	eventEnqueueScreenMove			(::gpk::apobj<::gpk::SSystemEvent> & queue, ::gpk::n2u16 coord)	{ return ::gpk::eventEnqueueChild(queue, ::gpk::SYSTEM_EVENT_Screen, ::gpk::EVENT_SCREEN_Move		, coord); }
