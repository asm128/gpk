...
#pragma pack(pop)
	...
	static inline			::gpk::error_t												jsonObjectValueGet		(const ::gpk::SJSONReader& reader, uint32_t iNode, const ::gpk::view_const_char& key)	noexcept	{ return ::gpk::jsonObjectValueGet(*reader.Tree[iNode], reader.View, {key.begin(), key.size()}); }
							...
							::gpk::error_t												jsonObjectKeyList		(const ::gpk::SJSONNode& node, const ::gpk::view_array<::gpk::view_const_string>& views, ::gpk::array_obj<::gpk::view_const_string> & keys);
	...
	static inline			::gpk::error_t												jsonObjectKeyList		(const ::gpk::SJSONReader& reader, uint32_t iNode, ::gpk::array_pod<int32_t> & indices)																													{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i", iNode); return jsonObjectKeyList(*reader.Tree[iNode], indices);					}
	static inline			::gpk::error_t												jsonObjectKeyList		(const ::gpk::SJSONReader& reader, uint32_t iNode, const ::gpk::view_array<::gpk::view_const_string>& views, ::gpk::array_obj<::gpk::view_const_string> & keys)											{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i", iNode); return jsonObjectKeyList(*reader.Tree[iNode], views, keys);				}
	static inline			::gpk::error_t												jsonObjectKeyList		(const ::gpk::SJSONReader& reader, uint32_t iNode, const ::gpk::view_array<::gpk::view_const_string>& views, ::gpk::array_pod<int32_t> & indices, ::gpk::array_obj<::gpk::view_const_string> & keys)	{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i", iNode); return jsonObjectKeyList(*reader.Tree[iNode], views, indices, keys);	}
