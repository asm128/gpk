...
::gpk::error_t												setup					(::gme::SApplication & app)						{ 
	...
	app.GUI.Colors.resize(::gpk::GUI_CONTROL_COLOR_COUNT);
	app.GUI.Colors[::gpk::GUI_CONTROL_COLOR_BACKGROUND		]	= {0x7F, 0x7F, 0x7F, 0xFF};
	app.GUI.Colors[::gpk::GUI_CONTROL_COLOR_CLIENT			]	= {0x00, 0x7F, 0x7F, 0xFF};
	app.GUI.Colors[::gpk::GUI_CONTROL_COLOR_BORDER_LEFT		]	= {0x00, 0x00, 0xFF, 0xFF};
	app.GUI.Colors[::gpk::GUI_CONTROL_COLOR_BORDER_TOP		]	= {0x00, 0xFF, 0x00, 0xFF};
	app.GUI.Colors[::gpk::GUI_CONTROL_COLOR_BORDER_RIGHT	]	= {0xFF, 0x00, 0x00, 0xFF};
	app.GUI.Colors[::gpk::GUI_CONTROL_COLOR_BORDER_BOTTOM	]	= {0xFF, 0xFF, 0x00, 0xFF};
	...
	controlRoot.ColorBorder.Left								= ::gpk::GUI_CONTROL_COLOR_BORDER_LEFT		;
	...
	for(uint32_t iChild = 0; iChild < 810; ++iChild) {
		...
		control.ColorBorder.Left									= ::gpk::GUI_CONTROL_COLOR_BORDER_LEFT		;
		control.ColorBorder.Top										= ::gpk::GUI_CONTROL_COLOR_BORDER_TOP		;
		control.ColorBorder.Right									= ::gpk::GUI_CONTROL_COLOR_BORDER_RIGHT		;
		control.ColorBorder.Bottom									= ::gpk::GUI_CONTROL_COLOR_BORDER_BOTTOM	;
		switch(iChild % 9) {										  
