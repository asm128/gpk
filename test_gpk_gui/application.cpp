...
::gpk::error_t												setup					(::gme::SApplication & app)						{ 
	...
	app.GUI.ControlConstraints[controlTestRoot].IndexControlToAttachHeightTo	= controlTestRoot;
	app.GUI.ControlConstraints[controlTestRoot].IndexControlToAttachWidthTo		= controlTestRoot;
