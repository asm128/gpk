...
namespace gpk
{
	...
	stainli	::gpk::error_t	tcpipAddressToSockaddr		(const ::gpk::SIPv4Endpoint & addr, sockaddr_in & sockaddr)	{ return tcpipAddressToSockaddr		
	...
	stainli	::gpk::error_t	tcpipAddressFromSockaddr	(const sockaddr_in& sockaddr, ::gpk::SIPv4Endpoint & address)	{ uint8_t addr[4] = {}; gpk_necs(tcpipAddressFromSockaddr	(sockaddr	, &addr[0], &addr[1], &addr[2], &addr[3], &address.Port)); address.IP = SIPv4{addr[0], addr[1], addr[2], addr[3]}; return 0; }
	stainli	::gpk::error_t	tcpipAddress				(SOCKET socket, ::gpk::SIPv4Endpoint & address)					{ uint8_t addr[4] = {}; gpk_necs(tcpipAddress				(socket		, &addr[0], &addr[1], &addr[2], &addr[3], &address.Port)); address.IP = SIPv4{addr[0], addr[1], addr[2], addr[3]}; return 0; }
} // namespace
