...
#	include <Windows.h>
			...
			::gpk::error_t						gpk::loadCGIModule					(::gpk::SCGIModule& loadedModule, const ::gpk::view_const_char& moduleName)				{
	...
	const ::gpk::view_array<const ::gpk::STypeIdentifier>	& funcnames						= TRegistry::get_types();
	const ::gpk::view_array<const ::gpk::DATA_TYPE>			& members						= TRegistry::get_data_type_ids();
