...
::gpk::error_t	gpk::appendString			(::gpk::achar & output, gpk::SIPv4 ip, char separator) { 
	char				buffer[16]	= {};
	::gpk::error_t		len;
...
::gpk::error_t	gpk::appendBraced			(::gpk::achar & output, gpk::SIPv4 ip, char separator) { 
	char				buffer[16]	= {};
	gpk_necs(ip.print(buffer, separator));
	return ::gpk::appendBraced(output, buffer);
}

::gpk::error_t	gpk::appendQuoted			(::gpk::achar & output, gpk::SIPv4 ip, char separator) { 
	char				buffer[16]	= {};
	gpk_necs(ip.print(buffer, separator));
	return ::gpk::appendQuoted(output, buffer);
}

::gpk::error_t	gpk::appendBracedPrefixed	(::gpk::achar & output, gpk::SIPv4 ip, bool usePrefix, char prefix, char ip_separator) { 
	if(false == usePrefix) 
...
::gpk::error_t	gpk::appendQuotedPrefixed	(::gpk::achar & output, gpk::SIPv4 ip, bool usePrefix, char prefix, char ip_separator) { 
	if(false == usePrefix) 
