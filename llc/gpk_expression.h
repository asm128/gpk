...
namespace gpk
{
	...
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, STRING					, 4);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, BOOL						, 5);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, EVALUATION				, 6);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, EXPRESSION_CONDITION		, 7);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, CODEPOINT				,  9);
