...
#pragma pack(pop)
	...
	stainli	::gpk::error_t	jsonObjectKeyList		(const ::gpk::SJSONReader & reader, uint32_t iNode, ::gpk::avcc & keys)							{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); return jsonObjectKeyList(*reader.Tree[iNode], reader.View, keys);			}
	stainli	::gpk::error_t	jsonObjectKeyList		(const ::gpk::SJSONReader & reader, uint32_t iNode, ::gpk::ai32 & indices, ::gpk::avcc & keys)	{ ree_if(iNode >= reader.Tree.size(), "Invalid node index: %i. Total nodes: %u", iNode, reader.Tree.size()); return jsonObjectKeyList(*reader.Tree[iNode], reader.View, indices, keys);	}
	...
	stainli	::gpk::error_t	jsonObjectGetString		(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, vcc		& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = reader.View[index]; return index; }
	stainli	::gpk::error_t	jsonObjectGetBoolean	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, bool	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (bool )reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, i64_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (i64_t)reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, i32_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (i32_t)reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, i16_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (i16_t)reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, i8_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (i8_t )reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, u64_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (u64_t)reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, u32_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (u32_t)reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, u16_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (u16_t)reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetInteger	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, u8_t	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); value = (u8_t )reader.Token[index].Value; return index; }
	stainli	::gpk::error_t	jsonObjectGetDecimal	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, double	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); double dealiased; memcpy(&dealiased, &reader[index]->Token->Value, sizeof(double)); value = dealiased; return index; }
	stainli	::gpk::error_t	jsonObjectGetDecimal	(const ::gpk::SJSONReader & reader, uint32_t iNode, const ::gpk::vcs & key, float	& value)	{ int32_t index; gpk_necs(index = jsonObjectValueGet(reader, iNode, key)); double dealiased; memcpy(&dealiased, &reader[index]->Token->Value, sizeof(double)); value = (float)dealiased; return index; }
