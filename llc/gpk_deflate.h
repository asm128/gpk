...
namespace gpk
{
	...
	::gpk::error_t				fileToMemorySecure				(::gpk::SLoadCache& recycle, ::gpk::apod<char>	& loadedBytes	, const ::gpk::vcc & fileName, const ::gpk::vcc & key, const bool deflate);
	...
	stainli	::gpk::error_t		fileToMemorySecure				(::gpk::apod<char>	& loadedBytes	, const ::gpk::vcc & fileName, const ::gpk::vcc & key, const bool deflate) { ::gpk::SLoadCache temp; return ::gpk::fileToMemorySecure	(temp, loadedBytes	, fileName, key, deflate); }
