...
#	define GPK_REDEFINE_NULL_ASAP
	...
	//GDEFINE_ENUM_VALUE(JSON_TYPE, FLOAT		, 3);
	GDEFINE_ENUM_VALUE(JSON_TYPE, STRING	, 4);
	GDEFINE_ENUM_VALUE(JSON_TYPE, KEY		, 5);
	GDEFINE_ENUM_VALUE(JSON_TYPE, OBJECT	, 6);
	GDEFINE_ENUM_VALUE(JSON_TYPE, ARRAY		, 7);
	GDEFINE_ENUM_VALUE(JSON_TYPE, CODEPOINT	, 8);
	GDEFINE_ENUM_VALUE(JSON_TYPE, COUNT		, 9);
