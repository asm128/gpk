...
namespace gpk
{
	...
	static	::gpk::error_t		drawLine				(const ::gpk::n2<uint16_t>& targetMetrics, const ::gpk::SLine3<_tCoord>& line, const ::gpk::m4<float> & mWVP, ::gpk::apod<::gpk::n3<float>>& out_Points, ::gpk::v2u32 depth) {
