...
struct SCamera {
	...
	::gpk::SFramework															& framework									= app.Framework;
	::gpk::SGUI																	& gui										= *framework.GUI;
	buffer3d->resize(gui.Controls.Controls[gui.Controls.Children[app.DialogMain.Controls[app.Viewport]->IdGUIControl][0]].Area.Size.Cast<uint32_t>(), 0xFF000080, (uint32_t)-1);
