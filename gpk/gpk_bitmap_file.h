...
namespace gpk
{
	...
	::gpk::error_t			bmpFileLoad	(const int8_t					* source	, ::gpk::apod<::gpk::SColorBGRA>& out_Colors, ::gpk::view2d<::gpk::SColorBGRA>& out_ImageView);
	...
	stainli	::gpk::error_t	bmpFileLoad	(const int8_t					* source	, ::gpk::img<::gpk::SColorBGRA>& out_Texture)	{ return bmpFileLoad(source		, out_Texture.Texels, out_Texture.View); }
