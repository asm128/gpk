...
::gpk::error_t									gpk::filterPostfix					(::gpk::view_array<const ::gpk::vcc> input, const ::gpk::vcc postfix, ::gpk::aobj<::gpk::vcc> & filtered, bool nullIncluded) { 
...
::gpk::error_t									gpk::filterPrefix					(::gpk::view_array<const ::gpk::vcc> input, const ::gpk::vcc prefix, ::gpk::aobj<::gpk::vcc> & filtered, bool nullIncluded) { 
	for(uint32_t iInput = 0; iInput < input.size(); ++iInput) { 
		const ::gpk::vcc & currentInput = input[iInput]; 
