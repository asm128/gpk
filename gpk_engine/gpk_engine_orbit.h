...
namespace gpk
{
	...
	::gpk::error_t			initOrbitCenter		(::gpk::SBodyCenter & orbitCenter, ::gpk::AXIS rotationAxis, double orbitalInclination, double orbitRadius);
	...
	::gpk::error_t			initOrbiterOrbit	(::gpk::SBodyCenter & orbitCenter , ::gpk::SBodyForces & orbitForces, double orbitalInclination, double orbital_period, double orbital_unit);
	::gpk::error_t			initOrbiterCenter	(::gpk::SBodyCenter & planetCenter, double orbitalInclination, double orbitRadius, double radiusScale);
	...
	stainli	::gpk::error_t	initOrbiterCenter	(const ::gpk::SOrbiter & bodyData, ::gpk::SBodyCenter	& planetCenter, double distanceScale) {
		return ::gpk::initOrbiterCenter(planetCenter, bodyData.Orbit.AxialTilt, bodyData.Orbit.Radius, distanceScale);
	}
	...
	stainli	::gpk::error_t	initOrbiterCenter	(const ::gpk::SOrbiter & bodyData, ::gpk::SRigidBodyIntegrator & integrator, int32_t rigidBodyIndex, double distanceScale) {
		return ::gpk::initOrbiterCenter(integrator.Centers[rigidBodyIndex], bodyData.Orbit.AxialTilt, bodyData.Orbit.Radius, distanceScale);
	}
