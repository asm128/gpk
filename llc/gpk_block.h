...
#pragma pack(pop)
	...
	struct SMapBlock {
		...
		inline	::gpk::error_t					Size						()									const	{ return Allocator.Views.size(); }
		...
		::gpk::error_t							MapAdd						(const ::gpk::vcub & dataToAdd);
		::gpk::error_t							MapId						(const ::gpk::vcub & dataToFind)	const;
		::gpk::error_t							MapGet						(int32_t index, ::gpk::vcub & data)	const;
	};
} // namespace
