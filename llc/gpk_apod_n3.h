...
#pragma pack(push, 1)
	...
	typedef	::gpk::apod<::gpk::n3u8		>	an3u8	;
	typedef	::gpk::apod<::gpk::n3u16	>	an3u16	;
	typedef	::gpk::apod<::gpk::n3u32	>	an3u32	;
	typedef	::gpk::apod<::gpk::n3u64	>	an3u64	;
	typedef	::gpk::apod<::gpk::n3i8		>	an3i8	;
	typedef	::gpk::apod<::gpk::n3i16	>	an3i16	;
	typedef	::gpk::apod<::gpk::n3i32	>	an3i32	;
