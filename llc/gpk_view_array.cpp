...
::gpk::error_t			gpk::trim				(::gpk::view_const_string & trimmed, const ::gpk::view_const_string & original, const ::gpk::view_const_char & characters)	{
	const uint32_t				countChars				= ::gpk::ltrim(trimmed, original, characters);
	return countChars + ::gpk::rtrim(trimmed, characters);
}

::gpk::error_t			gpk::rtrim				(::gpk::view_const_string & trimmed, const ::gpk::view_const_string & original, const ::gpk::view_const_char & characters)	{
...
::gpk::error_t			gpk::ltrim				(::gpk::view_const_string & trimmed, const ::gpk::view_const_string & original, const ::gpk::view_const_char & characters)	{
	uint32_t					iChar					= 0;
	while(iChar < original.size() && ::isAnyOfCharacters(characters, trimmed[iChar]))
		++iChar;
