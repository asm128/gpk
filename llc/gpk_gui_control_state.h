...
#pragma pack(push, 1)
	...
	stainli	::gpk::error_t	eventEnqueueGuiControlStateChange(::gpk::apobj<::gpk::SEventSystem> & queue, ::gpk::cid_t iControl, GUI_CONTROL_FLAG oldState, GUI_CONTROL_FLAG newState) {
	...
	tplt<tpnm _tState>
	_tState				setValue		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, _tState & state, TFuncSetMaskedValue<_tState> funcSetValue) {
	...
	struct SControlState {
		...
		bool				SetHovered		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setHovered (Flag, Mask, value); })); }
		bool				SetPressed		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setPressed (Flag, Mask, value); })); }
		bool				SetHidden		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setHidden  (Flag, Mask, value); })); }
		bool				SetFocused		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setFocused (Flag, Mask, value); })); }
		bool				SetSelected		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setSelected(Flag, Mask, value); })); }
		bool				SetDisabled		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setDisabled(Flag, Mask, value); })); }
		bool				SetUpdated		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setUpdated (Flag, Mask, value); })); }
		bool				SetAction		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setAction  (Flag, Mask, value); })); }
		bool				SetUnused		(::gpk::cid_t iControl, ::gpk::apobj<SEventSystem> & eventQueue, bool value)	noexcept	{ return 0 != (Flag = setValue<GUI_CONTROL_FLAG>(iControl, eventQueue, Flag, [this, &value]() { return setUnused  (Flag, value);       })); }
