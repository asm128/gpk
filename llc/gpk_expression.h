...
namespace gpk
{
	...
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, KEY				,  6);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, LITERAL			,  7);
	GDEFINE_ENUM_VALUE(EXPRESSION_READER_TYPE, UNARY_NOT		,  8);
