...
{	
	...
	stainli	::gpk::error_t	eventEnqueueTextChar		(::gpk::apobj<::gpk::SEventSystem> & queue, uint32_t utf8)	{ return ::gpk::eventEnqueueChild(queue, ::gpk::SYSTEM_EVENT_Text, ::gpk::EVENT_TEXT_Char, utf8); }
	...
	stainli	::gpk::error_t	eventEnqueueKeyboardUp		(::gpk::apobj<::gpk::SEventSystem> & queue, uint8_t key)	{ return ::gpk::eventEnqueueChild(queue, ::gpk::SYSTEM_EVENT_Keyboard, ::gpk::EVENT_KEYBOARD_Up		, key); }
	stainli	::gpk::error_t	eventEnqueueKeyboardDown	(::gpk::apobj<::gpk::SEventSystem> & queue, uint8_t key)	{ return ::gpk::eventEnqueueChild(queue, ::gpk::SYSTEM_EVENT_Keyboard, ::gpk::EVENT_KEYBOARD_Down	, key); }
	stainli	::gpk::error_t	eventEnqueueKeyboardSysUp	(::gpk::apobj<::gpk::SEventSystem> & queue, uint8_t key)	{ return ::gpk::eventEnqueueChild(queue, ::gpk::SYSTEM_EVENT_Keyboard, ::gpk::EVENT_KEYBOARD_SysUp	, key); }
	stainli	::gpk::error_t	eventEnqueueKeyboardSysDown	(::gpk::apobj<::gpk::SEventSystem> & queue, uint8_t key)	{ return ::gpk::eventEnqueueChild(queue, ::gpk::SYSTEM_EVENT_Keyboard, ::gpk::EVENT_KEYBOARD_SysDown, key); }
	...
	stainli	::gpk::error_t	eventEnqueueMouseWheel		(::gpk::apobj<::gpk::SEventSystem> & queue, int16_t delta )		{ return ::gpk::eventEnqueueChild(queue, ::gpk::SYSTEM_EVENT_Mouse, ::gpk::EVENT_MOUSE_Wheel		, delta ); }
