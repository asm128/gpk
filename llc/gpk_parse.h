...
namespace gpk
{
	...
	template<typename _tInt>	inline	::gpk::error_t			parseIntegerHexadecimal			(const ::gpk::view_const_string& sourceChars, _tInt* number_)	{ uint64_t number; gpk_necall(::gpk::parseArbitraryBaseInteger(10, "0123456789", sourceChars, &number), "%s", "Unknown error."); *number_ = (_tInt)number; return 0; };
